...
import './assets/Bjuego.css';
 
class Bjuego extends Component{
    constructor(props) {
        super(props)
        this.state = {
            playerVal : null,
    ...
    render(){
        ...
        return(
            <div className="container-bjuego">
                <h1>Welcome to Rock, Paper, Scissors Bjuego</h1>
                <div >
